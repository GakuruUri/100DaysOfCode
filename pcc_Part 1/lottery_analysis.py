...
def get_winning_ticket(possibilities):
    ...
    # We don't want to repeat winning numbers or letters so we will use a while loop.
...
def check_ticket(played_ticket, winning_ticket):
    # Check all elements in the played ticket. If they are not in the winning ticket, return False.
...
def make_random_ticket(possibilities):
    ...
    while len(ticket) < 4:
        ...
        # Only add the pulled item on the ticket if  it hasn't already been pulled.
